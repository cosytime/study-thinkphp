...
class createMenuValidate extends Validate
{
    ...
    protected $scene = [
        'G' => ['parent_id', 'name', 'menu_type', 'menu_sort', 'title', 'remark'],
        'M' => ['parent_id', 'name', 'menu_type', 'menu_sort', 'hidden', 'hidden_children', 'keep_alive', 'is_frame', 'path', 'title', 'permission', 'component', 'redirect', 'icon', 'status', 'remark'],
        'C' => ['parent_id', 'name', 'menu_type', 'menu_sort', 'hidden', 'hidden_children', 'keep_alive', 'is_frame', 'path', 'title', 'component', 'permission', 'icon', 'status', 'remark'],
        'F' => ['parent_id', 'menu_type', 'menu_sort', 'title', 'permission', 'status', 'remark']
    ];
}